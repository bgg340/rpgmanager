...
public class CharacterController {
	...
	// for viewing one character at a time. uses pathVariable to find right one
	// through id
	...
	// same as add, but this was a test for making a separate one for non-admins.
	...
	// for editing players. only meant for changing their characters, but you could
	// do stupid stuff with this...
	...
	// you can see all the characters and more here. Should probably be locked
	// somehow...
